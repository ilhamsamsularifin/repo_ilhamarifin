...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                <h2 class="text-center mt-3">Form Input Data</h2>
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="alamat" id="alamat" class="form-control" placeholder="Tulis Alamat Lengkap" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="asal_sekolah" id="asal_sekolah" class="form-control" placeholder="Tulis Asal Sekolah" required="">
                    </div>
